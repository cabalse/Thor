export const MOVE_INSTRUCTIONS = `When it is your turn, respond with ONLY a list of actions, one per line. Do not include any commentary, explanation, or extra text outside these lines — your reasoning should happen in your own thinking, not in the response itself.
